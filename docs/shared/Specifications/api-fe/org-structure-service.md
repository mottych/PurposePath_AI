...
[People + Org consolidated in this document] | [Back to Index](./index.md)
...
> Migrated from the former people-service.md to consolidate all People contracts in this Org spec.
...
Deactivate a person (compatibility route). Same behavior and payload as `DELETE /people/{id}`.
...
[Top of document](./org-structure-service.md) | [Back to Index](./index.md)