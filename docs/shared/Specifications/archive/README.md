...
|------|---------|---------------|---------------|-------|
| `backend-integration-traction-service-v5.md` | v5.0 | December 23, 2025 | v7 modular specs | Monolithic spec with deprecated KPI entities |
...
- [`kpis-api.md`](../traction-service/kpis-api.md) - 7 endpoints
- [`kpi-links-api.md`](../traction-service/kpi-links-api.md) - 8 endpoints
- [`kpi-data-api.md`](../traction-service/kpi-data-api.md) - 9 endpoints
...
- ❌ `GoalKpiLink` → ✅ `KpiLink` (unified linking model)
- ❌ `KpiMilestone` → ✅ `KpiData` (unified target/actual model)
- ❌ `KpiActual` → ✅ `KpiData`
- ❌ `KpiReading` → ✅ `KpiData`
