...
class BusinessContextForLLM(BaseModel):
    ...
    core_values: list[str] | None = Field(default=None, description="Organization's core values")
    purpose: str | None = Field(default=None, description="Organization's purpose")
    vision: str | None = Field(default=None, description="Organization's vision")
    mission: str | None = Field(default=None, description="Organization's mission")
    goals: list[dict[str, Any]] | None = Field(default=None, description="Strategic goals")

    # Dynamic existing fields based on coaching topic
    existing_core_values: list[str] | None = Field(default=None)
    existing_purpose: str | None = Field(default=None)
    existing_vision: str | None = Field(default=None)
    existing_goals: list[dict[str, Any]] | None = Field(default=None)
...
class SessionOutcomes(BaseModel):
    ...
    summary: str | None = Field(default=None, description="Brief summary of session outcomes")
    business_impact: str | None = Field(default=None, description="Potential impact on business")
