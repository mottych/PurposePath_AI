        ...
        try:
            ...
            for event in all_events:
                ...
                if "send_message" in msg:
                    ...
                    print(f"✓ Found send_message call")
                ...
                if "llm_call_completed" in msg:
                    ...
                    try:
                        if "processing_time_ms=" in msg:
                            ...
                            print(f"⏱️  LLM call #{llm_call_count} completed: {duration_ms/1000:.2f}s at {ts.strftime('%H:%M:%S')}")
                    except:
                        print(f"⏱️  LLM call #{llm_call_count} completed at {ts.strftime('%H:%M:%S')}")
            ...
            if has_extraction or has_is_final_true:
                ...
                if llm_durations:
                    ...
                    print(f"   This suggests Bedrock throttling/queueing!")
